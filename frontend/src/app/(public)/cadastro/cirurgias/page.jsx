    ...
    <div className="flex min-h-screen text-main bg-background">
      ...
      <main className="flex-1 p-6 mt-4">
        <div className="max-w-10xl mx-auto">
          <h1 className="flex items-center gap-2 text-2xl font-bold mb-6 text-center">Cadastro de Cirurgias</h1>

          <div className="bg-offwhite p-6 rounded-lg shadow">
            <h2 className="text-xl text-darkgray font-semibold mb-4">3. Cirurgias</h2>
            <h3 className="text-darkgray mb-8">Informe as cirurgias realizadas pelo paciente:</h3>
